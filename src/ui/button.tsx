  ...
  'cursor-pointer inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-medium ring-offset-white transition-all focus-visible:outline-hidden focus-visible:ring-2 focus-visible:ring-neutral-950 focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 dark:ring-offset-neutral-950 dark:focus-visible:ring-neutral-300',
  {
    variants: {
      variant: {
        ...
        'brand-outline': 'border border-orange-600 text-orange-600 hover:border-orange-500 hover:text-orange-500 dark:border-orange-600 dark:text-orange-600 dark:hover:border-orange-600/90',
